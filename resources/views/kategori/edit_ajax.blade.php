            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select name="level_kategori" id="level_kategori" class="form-control" required>
                        ...
                        @foreach ($kategoriList as $item)
                            <option value="{{ $item->kategori_kode }}" {{ $item->kategori_kode == $kategori->kategori_kode ? 'selected' : '' }}>
                                {{ $item->kategori_kode }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="kategori_nama" id="nama_kategori" class="form-control" required>
                        ...
                        @foreach ($kategoriList as $item)
                            <option value="{{ $item->kategori_nama }}" {{ $item->kategori_nama == $kategori->kategori_nama ? 'selected' : '' }}>
                                {{ $item->kategori_nama }}
                            </option>
                        @endforeach
                    </select>
